...
(function(){if(!window.KAMPYLE_EMBED){var onPremEmbedRegex=/\/[a-zA-Z\d-]+\/\d+\/onsite\/medallia-digital-embed\.js$/;window.KAMPYLE_EMBED={kampyleInit:function(){var t=document.createElement('script');t.type='text/javascript';t.async=true;t.src=KAMPYLE_EMBED.getGenericLocation();document.body.appendChild(t);},kampyleLoadLogger:function(){},kampyleEventHandler:function(elem,eventType,handler){if(elem.addEventListener){elem.addEventListener(eventType,handler,false);}
...
return false;},getGenericLocation:function(){var cloudLocation=location.protocol+'//'+'nebula-cdn.kampyle.com/wau/5271/onsite/generic1508746549671.js';var genericPath=(cloudLocation.match(/\/[a-zA-Z\d-]+\/\d+\/onsite\/generic\d{13}\.js$/)||[])[0];return window.KAMPYLE_EMBED.isOnPrem()?window.KAMPYLE_EMBED.getResourcesPrefix()+genericPath:cloudLocation;},getResourcesPrefix:function(){if(window.MDIGITAL_ON_PREM_PREFIX){return window.MDIGITAL_ON_PREM_PREFIX;}
